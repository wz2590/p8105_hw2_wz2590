...
The format of the data before and after the year 2000 are different.
Thus I need to read and tidy the old and new data separately. (It seems
that Mac users don’t have this problem?)
...
```
    ...
    ## # ... with 950 more rows, and 1 more variable: unemployment_percentage <dbl>
