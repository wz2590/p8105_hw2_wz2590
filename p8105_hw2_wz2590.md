...
345 observations in the trashWheels\_df data frame, each observation has
14 variables.

The precipitation\_comb data frame contains the precipitation(in) on
each month from Jan 2018 to Jun 2019. There are 24 observations in this
data frame
...
observations having 17 variables. The year ranges from 1947 to 2015.
